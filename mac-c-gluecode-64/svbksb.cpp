...
extern "C"
int lisp_svbksb(double *u, double w[], double *v,
...
extern "C"
int lisp_svdlms_solve(double *m, double *v, int nrow, int ncol,
		    double tol, double *x)
{
  int err = 0;
  double **ma = 0;
...
extern "C"
int lisp_svdpredict(double *v, double *xv, int nel, int ncol,
		     double tol, double *pred, int npred,
